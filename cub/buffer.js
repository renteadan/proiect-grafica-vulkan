function memoryCopy(dstPtr, srcData, byteLen) {
...
function uploadBufferData(opts = {}) {
  let {
    data,
    usage,
    buffer,
...
module.exports={copyBuffer, createBuffer,uploadBufferData,getMemoryTypeIndex , memoryCopy }